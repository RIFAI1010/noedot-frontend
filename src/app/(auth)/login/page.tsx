        ...
        <div className="flex min-h-screen items-center justify-center bg-zinc-800">
            <div className="flex flex-col items-center w-full max-w-md gap-6">
                ...
                <div className="w-full bg-zinc-900 p-6 rounded-lg shadow-md">
                    <h2 className="text-2xl mb-3 font-bold text-center text-white">Login</h2>
                    ...
                    <form className="space-y-4" onSubmit={handleSubmit}>
                        ...
                        <div className="flex items-center justify-end">
                            <a href="/forgot-password" className="text-zinc-500 hover:underline">
                                Forgot Password?
                            </a>
                        </div>
                    ...
                    <p className="mt-4 text-center text-sm text-white">
                        ...
                        <Link href="/register" className="text-zinc-500 hover:underline">
                            Register
                        </Link>
                    </p>
                </div>
